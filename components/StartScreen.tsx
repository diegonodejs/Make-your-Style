          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Selecione uma foto nítida e de corpo inteiro. Fotos apenas do rosto também funcionam, mas o corpo inteiro é preferível para melhores resultados.</p>
            ...
            <AnimatePresence>
              {generatedModelUrl && !isGenerating && !error && (
                ...
                >
                  ...
                  >
                    Prosseguir para Estilizar &rarr;
                  </button>
                </motion.div>
              )}
            </AnimatePresence>
